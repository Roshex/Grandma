...
#        ("zhao2021", "grampa_trees.tre", "grampa_species_tree.tre"),
    ...
    for ds_name, g_file, s_file in datasets:
        ...
        time_tool(f"python {new_tool} -g {g} -s {s} -o {o_new}_splt/ {other_args} -m split --debug --plot -v 3 -p 10 --start auto -x {path_manual/'ploidies.txt'} --maps 6 --min_gt_lvs 1", "new") #--plot --start 1 -i 2
