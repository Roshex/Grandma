...
#        ("zhao2021", "grampa_trees.tre", "grampa_species_tree.tre"),
    ...
    for kind, dataset in datasets.items():
        for ds_name, g_file, s_file in dataset:
            ...
            run_str_new = f"python {new_tool} -g {g} -s {s} --debug --plot -v 3 -p 10 -o"# --root u -x E:\\Repos\\Grandma\\test\\test_data\\generator\\ex\\o_new2\\M12\\ploidies.txt --strict_constraint
