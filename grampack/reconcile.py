...
class Reconciler:
    ...
    @staticmethod
    def get_sister_clades(mul_data: MulTree) -> Tuple[Set[str], Set[str]]:
        """
        ...
        n2_obj = Reconciler._find_node_by_clade(mul_data.mt, h2_target)
        
        h1_sisters = Reconciler._get_sister_clade_labels(n1_obj) if n1_obj else []
        h2_sisters = Reconciler._get_sister_clade_labels(n2_obj) if n2_obj else []
    ...
    def compute_groups(gene_tree: SmrtTree, mul_data: MulTree, registry: NameRegistry,
        ...
        if mul_data.h1_node and (h1_sisters is None):
            h1_sisters, h2_sisters = Reconciler.get_sister_clades(mul_data)
